            ...
            ScrollView {
                ...
                VStack{
                    ...
                    HStack{
                        ...
                        Text( "LKR \( detailVM.pObj.totalPrice, specifier: "%.2f" )"  )
                    ...
                    HStack{
                        ...
                        Text( "+ LKR \( detailVM.pObj.deliverPrice ?? 0.0, specifier: "%.2f" )"  )
                            .font(.customfont(.medium, fontSize: 18))
                            .foregroundColor( .primaryText )
                    }
                    .padding(.bottom, 4)
                    ...
                    HStack{
                        ...
                        Text( "- LKR \( detailVM.pObj.discountPrice ?? 0.0, specifier: "%.2f" )"  )
                            .font(.customfont(.medium, fontSize: 18))
                            .foregroundColor( .red )
                    }
                    .padding(.bottom, 4)
                    ...
                    HStack{
                        ...
                        Text( "LKR \( detailVM.pObj.userPayPrice ?? 0.0, specifier: "%.2f" )"  )
                            .font(.customfont(.bold, fontSize: 22))
                            .foregroundColor( .primaryText )
                    }
                    .padding(.bottom, 4)
